...
# this script is modified slightly from the standard distributed script.  It runs the jboss process in
# the background, dumping the console output to /dev/null.
