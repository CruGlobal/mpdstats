...
rem let applications deployed on this server know what url to use to reach it (useful for sending emails asynchronously, when no HttpServletRequest is available from which to pick out the server url)
set JAVA_OPTS=%JAVA_OPTS% -Dorg.ccci.serverUrl=http://localhost
