...
@Embeddable
public class SpecialCommitmentKey extends ValueObject implements Serializable
{
    ...
    SpecialCommitmentKey()
    {
    }

    public SpecialCommitmentKey(EmployeeId employeeId, ReportPeriod reportPeriod, int effectiveSequence)
    {
