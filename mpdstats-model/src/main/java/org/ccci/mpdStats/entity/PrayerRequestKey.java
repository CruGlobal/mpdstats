...
@Embeddable
public class PrayerRequestKey extends ValueObject implements Serializable
{
    ...
    protected PrayerRequestKey()
    {
    }

    public PrayerRequestKey(EmployeeId employeeId, ReportPeriod reportPeriod)
    {
